  ...
  findByEmailOrMobile: (username, callback) => {
    ...
    startConnection((err, connection) => {
      ...
      connection.query(sql, [username, username], (queryErr, results) => {
        ...
        if (queryErr) {
          console.error("Database query error: 61", queryErr);
          return callback(
    ...
    startConnection((err, connection) => {
      ...
      connection.query(
        ...
        (queryErr, results) => {
          ...
          if (queryErr) {
            console.error("Database query error: 63", queryErr);
            return callback(
              { message: "Database query error", error: queryErr },
              null
            );
  ...
  updateToken: (id, token, tokenExpiry, callback) => {
    ...
    startConnection((err, connection) => {
      ...
      connection.query(sql, [token, tokenExpiry, id], (queryErr, results) => {
        ...
        if (queryErr) {
          console.error("Database query error: 64", queryErr);
          return callback(
  ...
  validateLogin: (id, callback) => {
    ...
    startConnection((err, connection) => {
      ...
      connection.query(sql, [id], (queryErr, results) => {
        ...
        if (queryErr) {
          console.error("Database query error: 65", queryErr);
          return callback(
            { message: "Database query error", error: queryErr },
            null
          );
  ...
  logout: (id, callback) => {
    ...
    startConnection((err, connection) => {
      ...
      connection.query(sql, [id], (queryErr, results) => {
        ...
        if (queryErr) {
          console.error("Database query error: 66", queryErr);
          return callback(
            { message: "Database update error", error: queryErr },
            null
          );
