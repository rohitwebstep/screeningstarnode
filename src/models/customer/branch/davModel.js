      ...
      (tableErr, tableResults) => {
        ...
        if (tableResults[0].count === 0) {
          ...
          CREATE TABLE \`${db_table}\` (
            ...
            KEY \`cmt_application_dav_id\` (\`dav_id\`),
            ...
            CONSTRAINT \`fk_${db_table}_dav_id\` FOREIGN KEY (\`dav_id\`) REFERENCES \`cmt_applications\` (\`id\`) ON DELETE CASCADE
              ...
              if (entryResults.length > 0) {
                ...
                pool.query(
                  insertSql,
                  {
                    ...
                    branch_id,
                    customer_id,
                    dav_id, // Include dav_id in the insert statement
                  },
                  (insertErr, insertResult) => {
                    if (insertErr) {
                      console.error("Error inserting application:", insertErr);
