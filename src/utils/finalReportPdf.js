                  ...
                  try {
                    ...
                    doc.autoTable({
                      ...
                      body: servicesData.map((service) => {
                        ...
                        const notstatusContent =
                          service.annexureData.status || "Not Verified";
                        ...
                        return [
                          {
                            content: JSON.parse(service.reportFormJson.json)
                              .heading, // Adjust as needed based on the JSON structure
